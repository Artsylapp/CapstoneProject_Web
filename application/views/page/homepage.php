				...
				<?php foreach($locations as $location): ?>
					...
					<?php if ($location->location_tbl_status == "BOOKED"): ?>
						<div class="col-s-2 homenavbtn margin-all">
							<button name="<?php echo htmlspecialchars($location->location_tbl_name); ?>" id="btn-<?php echo $locationId; ?>" class="btn menu-btn-location lr-bg ttsh" data-freetime="<?php echo $freetime; ?>">
