...
width: 100%;">
    ...
    <div class="profile-sidebar" style="display: flex; justify-content: center; align-items: center; border-style: solid; background-color: #F2F2F2; border-radius: 5px; padding:3%; margin-bottom:10%; padding:18%; width: 100%;">
        <div style="display: flex;">
        ...
        <div style="">
            <div style="display: flex; justify-content: center; align-items: center; text-align: center;">
                <div>
                    <p style="font-size: 40px;">ORDERS REMAINING</p>
