	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-xs-4 col-sm-4 center-item">
				<button id="continue-button" class="btn green-bg menu-btn-m center-item ttsh" name="Proceed to area placement" data-base-url="<?php echo $this->config->base_url('orders/save_services'); ?>">
                    <h3>CONTINUE</h3>
                </button>
			</div>
